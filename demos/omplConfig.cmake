...
set(OMPL_VERSION 2.0.0-beta)
set(OMPL_MAJOR_VERSION 2)
set(OMPL_MINOR_VERSION 0)
set(OMPL_PATCH_VERSION 0)
set_and_check(OMPL_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/ompl-2.0)

include ("${CMAKE_CURRENT_LIST_DIR}/omplExport.cmake" )
include(CMakeFindDependencyMacro)
set(_ompl_boost_components serialization)
...
if(TARGET ompl::ompl)
    ...
    foreach(_lib Boost::serialization;)
        if(_lib)
...
set_and_check(OMPL_LIBRARY_DIRS "${PACKAGE_PREFIX_DIR}/lib")
foreach(_dir ;;;)
    if(_dir)
